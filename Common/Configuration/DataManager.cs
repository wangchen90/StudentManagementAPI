...
namespace Common.Configuration
{
    public class MySqlConnection : AppConfiguration, IDisposable
    {
        ...
        private nint handle;  // Pointer to an external unmanaged resource.
    ...
    public class MySqlCommand : IDisposable
    {
        ...
        public async Task<bool> Execute_Query_WithTransaction(string Query, CommandType CmdType,
        ...
        /// <param name="CommandType">Specify command type as Text if you passed Text as Query or 
        /// StoredProcedure if you passed name of Stored Procedure as Query</param>
        public async Task<bool> Execute_Query(string Query, CommandType CommandType)
        {
            try
            {
        ...
        public async Task<string> Select_Scalar(string Query, CommandType CommandType)
        {
            try
            {
        ...
        public async Task<DataTable> Select_Table(string Query, CommandType CommandType)
        {
        ...
        public async Task<DataSet> Select_TableSet(string Query, CommandType CommandType)
        {
